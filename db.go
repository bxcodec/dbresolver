...
func (db *sqlDB) PrepareContext(ctx context.Context, query string) (stmt1 *sql.Stmt, err error) {
	...
	var patchStmtMethods = func() {
		...
		guardExec = monkey.PatchInstanceMethod(
			stmtType,
			"ExecContext",
		...
		guardQuery = monkey.PatchInstanceMethod(
			stmtType,
			"QueryContext",
		...
		guardQueryRow = monkey.PatchInstanceMethod(
			stmtType,
			"QueryRowContext",
		...
		guardClose = monkey.PatchInstanceMethod(
			stmtType,
			"Close",
